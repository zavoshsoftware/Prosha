...
namespace ProshaSoft.Controllers
{
    public class BlogGroupsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,TitleEn,UrlParam,IsActive,CreationDate,LastModifiedDate,IsDeleted,DeletionDate,Description")] BlogGroup blogGroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,TitleEn,UrlParam,IsActive,CreationDate,LastModifiedDate,IsDeleted,DeletionDate,Description")] BlogGroup blogGroup)
        {
            if (ModelState.IsValid)
            {
				blogGroup.IsDeleted = false;
